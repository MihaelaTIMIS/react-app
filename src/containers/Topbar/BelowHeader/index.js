          ...
          <div className="gx-container">
            <div className="gx-header-horizontal-main-flex">
              ...
              <Link to="/" className="gx-d-block gx-d-lg-none gx-pointer gx-mr-xs-3 gx-pt-xs-1 gx-w-logo">
                <img alt="" src="https://spliik-asset.s3.eu-central-1.amazonaws.com/LogoSPLIIK_vertical_final.png"/></Link>
                ...
                <li className="gx-notify gx-notify-search gx-d-inline-block gx-d-lg-none">
                  <Popover overlayClassName="gx-popover-horizantal" placement="bottomRight" content={
                    <div className="gx-d-flex"><Dropdown overlay={menu}>
                      <Button>
                        Category <Icon type="down" theme="twoTone"   />
                      </Button>
                    </Dropdown>
                      <SearchBox styleName="gx-popover-search-bar"
                                 placeholder="Search in app..."
                                 onChange={this.updateSearchChatUser.bind(this)}
                                 value={this.props.searchText}/></div>
                  } trigger="click">
